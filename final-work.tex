...
\item{A data structure to map variable names to memory addresses was designed (\texttt{storage.c}).}
...
\item{More than 20 Pilot programs to test the compiler were created (\texttt{tests/*}).}
\end{enumerate}
